"""Smoke check that Story Architect still runs in the first pipeline."""
...
def main() -> None:
    ...
    task = director.start_production(
        ProductionRequest(
            ...
            episode_goal="Verify the first Story Architect pipeline transition.",
            duration_seconds=60,
        )
    )
...
if __name__ == "__main__":
    main()
    print("smoke_story_architect_ok")
